...
# ====== 全局可配置参数（可直接在此处修改） ======
USER_NAME = "cmwc"         # 用户名
UUID = "4e1aa169-e2e8-4a8c-b26d-7f163fa18efe"                     # UUID，留空则自动生成
PORT = 65432                   # Vmess端口，留空或0则自动生成
DOMAIN = "aa.cmwc.dpdns.org"                   # 域名，留空则自动获取
CF_TOKEN = "eyJhIjoiYWU0OTIyM2I0ZDY2M2VkY2ZlYjVlOTA3ZDlmMWE2M2EiLCJ0IjoiYmQ1YzhkYzAtOThjZS00ZWI3LThjNzMtNDE4ZTQxNjEzNjExIiwicyI6IlptRXpNVGt5T1dZdFpEZGpZUzAwWXpVMExXSmtPRFV0T0ROak1tTTFZMkUwTkRNeiJ9"                 # Cloudflare Token，留空则用Quick Tunnel
# =========================================
